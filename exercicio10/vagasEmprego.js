...
function novaVaga() {
    ...
    const descrição = prompt("Informe uma descrição para vaga: ")
    const dataLimite = prompt("Informe uma data limite (dd/mn/aaa0 para vaga: ")
...
function inscreverCandidatos() {
    const candidato = prompt("Indorme o nome do candidato: ")
...
function excluirVaga() {
    const indice = prompt("Informe o indice da vaga que quer excluir: ")
    const vaga = vagas[indice]
